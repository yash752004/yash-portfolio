...
import { 
  Code, Blocks, Package, Server, Bot, 
  Smartphone, Globe, Cloud, Settings, Wrench,
  Gamepad2, Glasses, FileSpreadsheet, PenTool
} from "lucide-react";
...
export const servicesData: ServiceData[] = [
  {
    ...
    points: ["AI Product", "AI Calling Agents", "Predictive analytics", "LLM integrations"]
  },
  {
    id: "custom-software",
    ...
    points: ["Scalable architectures", "Bespoke business logic", "End-to-end delivery", "AI Integrations"]
  },
  {
    id: "erp",
    title: "ERP Solutions",
    ...
    points: ["Workflow automation", "Centralized dashboards", "Data synchronization", "AI Integrations"]
  },
  {
    id: "inventory",
    ...
    points: ["Real-time stock tracking", "Demand forecasting", "Supplier integrations", "AI Integrations"]
  },
  {
    id: "server",
    ...
    points: ["24/7 monitoring", "Automated backups", "Security patching", "AI Integrations"]
  },
  {
    id: "whatsapp",
    ...
    points: ["Automated notifications", "Customer support bots", "API integrations", "AI Integrations"]
  },
  {
    id: "mobile",
    ...
    points: ["iOS & Android apps", "Cross-platform tech", "App store deployment", "AI Integrations"]
  },
  {
    id: "web",
    ...
    points: ["React & Next.js", "SEO optimized", "High conversion UI", "AI Integrations"]
  },
  {
    id: "cloud",
    ...
    points: ["AWS / Azure / GCP", "Auto-scaling infrastructure", "DevOps pipelines", "AI Integrations"]
  },
  {
    id: "plc",
    ...
    points: ["IoT monitoring", "Real-time hardware data", "Industrial automation", "AI Integrations"]
  },
  {
    id: "uiux",
    title: "UI/UX Design",
    ...
    points: ["Wireframing & Prototyping", "User research", "Pixel-perfect design", "AI Integrations"]
  },
  {
    id: "support",
    ...
    points: ["Bug fixes & updates", "Performance tuning", "24/7 technical support", "AI Integrations"]
  },
  {
    id: "ar-vr",
    ...
    points: ["Immersive experiences", "Product visualization", "Virtual training", "AI Integrations"]
  },
  {
    id: "gaming",
    ...
    points: ["Unity & Unreal Engine", "Multiplayer architectures", "Cross-platform", "AI Integrations"]
  },
  {
    id: "excel-automation",
    ...
    points: ["Data migration", "Workflow automation", "Custom dashboards", "AI Integrations"]
  }
];
