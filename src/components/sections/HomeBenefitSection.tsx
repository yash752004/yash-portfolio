...
const HomeBenefitSection = () => {
  return (
    <section className="page-section bg-gradient text-white">
      <div className="container md:flex-row gap-16 items-start">
        ...
        <div className="w-4/10 flex items-start justify-center bg-white/60 backdrop-blur-md rounded-2xl text-black p-16 shadow-2xl">
          <div className="w-full space-y-6">
            <ul className="text-lg space-y-6">
              {data.benefits.map((benefit, index) => (
                <li key={index} className="flex items-start gap-6">
                  <div className="mt-1 flex-shrink-0 bg-secondary-100 dark:bg-secondary-900 text-secondary-600 rounded-full p-2">
        ...
        <div className="w-6/10 flex flex-col gap-10 py-16">
